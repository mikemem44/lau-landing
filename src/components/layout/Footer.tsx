    ...
    return (
        <footer className="grid grid-cols-1 w-full py-10 border-t border-border">
            <div className="grid grid-cols-1 md:flex md:justify-between gap-y-4 md:gap-y-0 md:mx-24">
                <label className="text-sm text-muted-foreground cursor-pointer md:text-md text-center md:text-start hover:text-accent-foreground hover:underline">EL PORTAFOLIO DE LAU</label>
