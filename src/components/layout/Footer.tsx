    ...
    return (
        <footer className="grid grid-cols-1 w-full py-10 border-t border-border">
            <div className="grid grid-cols-1 md:flex md:justify-between gap-y-4 md:gap-y-0 md:mx-24">
                <Link href="/" className="font-serif text-xl tracking-wide text-foreground text-center md:text-start hover:text-sidebar-accent-foreground ease-in-out transition duration-200">Laura Zambrano</Link>
